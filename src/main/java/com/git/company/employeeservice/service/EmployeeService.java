...
public class EmployeeService {
	...
	public String deleteEmployee(int id ) throws Exception {
	  ...
	  @ResponseStatus(value=HttpStatus.NOT_FOUND, reason="Employee Not Found")  // 404
	    ...
	    @ResponseStatus(value=HttpStatus.FORBIDDEN, reason="Software Developer must have a manager")  // 404
	    public static class ManagerNotFoundException extends RuntimeException {
	        
	    }
	    
	    @ResponseStatus(value=HttpStatus.FORBIDDEN, reason="Site Admin dose not have a manager")  // 404
